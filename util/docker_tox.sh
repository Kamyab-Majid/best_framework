...
docker exec glue_pytest pip3 install --upgrade pip3
docker exec glue_pytest pip3 install -r requirements_dev.txt
docker exec glue_pytest pip3 install tox
docker exec glue_pytest python3 -m tox
