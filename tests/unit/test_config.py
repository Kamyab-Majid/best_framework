...
from pynutrien.core import ConfigParser
...
@pytest.fixture(
    params=[
        (
            "tests/test_files/config_parser_test_data/config.json",
            "json",
            {"size": "small", "color": "red", "country": "USA"},
        ),
        (
            "tests/test_files/config_parser_test_data/config.ini",
            "ini",
            {"size": "small", "color": "red", "country": "USA"},
        ),
        (
            "tests/test_files/config_parser_test_data/fruits.yaml",
            "yaml",
            {"size": "small", "color": "red", "country": "USA"},
        ),
        (
            "tests/test_files/config_parser_test_data/config.toml",
            "toml",
            {"player_x": {"color": "blue"}, "player_o": {"color": "green"}},
        ),
    ],
    ids=["json_config", "ini_config", "yaml_config", "toml_config"],
    scope="session",
)
...
@pytest.fixture(
    params=[
        ("tests/test_files/config_parser_test_data/empty_config.json", "json"),
        ("tests/test_files/config_parser_test_data/empty_config.ini", "ini"),
        ("tests/test_files/config_parser_test_data/empty_fruits.yaml", "yaml"),
        ("tests/test_files/config_parser_test_data/empty_config.toml", "toml"),
    ],
...
def invalid_config_file_extension():
    return ("tests/test_files/config_parser_test_data/config.txt", "txt")


@pytest.fixture
def invalid_json_config():
    return ("tests/test_files/config_parser_test_data/invalid_config.json", "json")


@pytest.fixture
def invalid_ini_config():
    return ("tests/test_files/config_parser_test_data/invalid_config.ini", "ini")


@pytest.fixture
def invalid_yaml_config():
    return ("tests/test_files/config_parser_test_data/invalid_fruits.yaml", "yaml")


@pytest.fixture
def invalid_toml_config():
    return ("tests/test_files/config_parser_test_data/invalid_config.toml", "toml")
